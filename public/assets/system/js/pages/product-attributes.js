...
var DataTableProductAttributes = function () {
    var initDataTable = function () {
        ...
        dataTableInstance = $('#productAttributeTable').DataTable({
            dom: 't',
            processing: true,
            serverSide: true,
            pageLength: 9,
            ...
            order: [[0, 'desc']],
            ajax: {
                url: $('#productAttributeTable').data('url'),
                data: function (d) {
                    d.search = $('#productAttributeSearch').val();
                    var statuses = [];
...
document.addEventListener('DOMContentLoaded', function () {
    DataTableProductAttributes.init();
