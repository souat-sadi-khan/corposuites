...
var DataTableDesignations = function () {
    var initDataTable = function () {
        ...
        dataTableInstance = $('#designationTable').DataTable({
            dom: 't',
            processing: true,
            serverSide: true,
            pageLength: 9,
            ...
            order: [[0, 'desc']],
            ajax: {
                url: $('#designationTable').data('url'),
                data: function (d) {
                    d.search = $('#designationSearch').val();
                    var statuses = [];
            ...
            language: {
                emptyTable: `
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted mb-0">No designations available</p>
                    </div>
                `
            },
...
document.addEventListener('DOMContentLoaded', function () {
    DataTableDesignations.init();

    $('#designationSearch').on('keyup', function () { dataTableInstance.draw(); });
