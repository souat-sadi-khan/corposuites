            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<div class="tl-name-txt" style="font-weight:600;">' + data + '</div>' +
                               '<small class="text-muted d-block">' + row.message + '</small>';
                    }
                },
                {
                    data: 'is_read',
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Action 1: Delete Single Notification Row via delegation
    $('#dataTable tbody').on('click', '.delete-single-btn', function () {
        var id = $(this).data('id');
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `/admin/api/notifications/${id}`,
                    type: 'DELETE',
                    ...
                    success: function (res) {
                        if (res.success) {
                            ...
                            Lobibox.notify('error', {
                                ...
                                msg: res.message || 'Failed to delete notification.'
                            });
                        }
                    },
                    error: function() {
    ...
    $('#bulkDeleteBtn').on('click', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '/admin/api/notifications/delete-selected',
                    type: 'POST',
