...
var DataTableProductSerials = function () {
    var initDataTable = function () {
        ...
        dataTableInstance = $('#productSerialTable').DataTable({
            dom: 't',
            processing: true,
            serverSide: true,
            pageLength: 9,
            ...
            order: [[0, 'desc']],
            ajax: {
                url: $('#productSerialTable').data('url'),
                data: function (d) {
                    d.search = $('#productSerialSearch').val();
                    d.product_id = $('#productFilter').val();
                    d.warehouse_id = $('#warehouseFilter').val();
                    d.serial_status = $('#serialStatusFilter').val();
                    var statuses = [];
...
document.addEventListener('DOMContentLoaded', function () {
    DataTableProductSerials.init();

    // Search
    $('#productSerialSearch').on('keyup', function () {
