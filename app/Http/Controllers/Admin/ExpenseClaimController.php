...
class ExpenseClaimController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $query = ExpenseClaim::query()->with('employee');
            ...
            return DataTables::eloquent($query)
                ...
                ->addColumn('category_summary', function ($row) {
                    return '<b class="tl-name-txt">' . $row->category . '</b><br><small>' . number_format($row->amount, 2) . '</small>';
                })
                ...
                ->rawColumns(['status_badge', 'category_summary', 'employee_name', 'receipt_link', 'approval_badge', 'action'])
                ->make(true);
        }
    ...
    public function create()
    {
        ...
        return view('admin.expense-claims.create', compact('employees'));
    }
    ...
    public function edit(ExpenseClaim $expenseClaim)
    {
        ...
        return view('admin.expense-claims.edit', compact('expenseClaim', 'employees'));
    }
