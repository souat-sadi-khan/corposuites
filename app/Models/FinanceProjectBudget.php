...
class FinanceProjectBudget extends Model
{
    protected $table = 'finance_project_budgets';
    ...
    /**
     * A readable "01 Jan 2026 - 31 Dec 2026" range for the period this
     * budget covers.
     */
    ...
    {
        return $this->hasMany(FinanceProjectBudgetItem::class);
    }
