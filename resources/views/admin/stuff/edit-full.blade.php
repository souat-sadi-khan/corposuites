@extends('admin.layout.app', ['title' => t('stuff.update_stuff_information')])
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="bs-stepper-content">
                        ...
                        <form class="ajax_form" action="{{ route('admin.stuff.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                            @method('PATCH')
                            <!-- ========== STEP 1 ========== -->
                            <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane fm-body active" aria-labelledby="stepper2trigger1">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{ $model->name }}" placeholder="Full Name" />
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-4">
                                        ...
                                        <input type="text" name="phone" class="form-control" value="{{ $model->phone }}" placeholder="Phone" />
                                    </div>

                                    <div class="col-12 col-lg-4">
                                        <label class="form-label">Designation</label>
                                        <input type="text" name="designation" class="form-control" placeholder="Designation" value="{{ $model->profile->designation }}" />
                                    </div>

                                    <div class="col-12 col-lg-4">
                                        <label class="form-label">WhatsApp</label>
                                        <input type="text" name="whatsapp" class="form-control" placeholder="WhatsApp Number" value="{{ $model->profile->whatsapp }}" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Avatar</label>
                                        <input type="file" name="avatar" data-default-file="{{ $model->avatar ? asset($model->avatar) : '' }}" class="form-control dropify"/>
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Cover Photo</label>
                                        <input type="file" name="cover_photo" data-default-file="{{ $model->profile->cover_photo ? asset($model->profile->cover_photo) : '' }}" class="form-control dropify" />
                                    </div>

                                    <div class="col-12">
                                        <label class="form-label">Skills</label>
                                        <input type="text" name="skills" class="form-control tag" placeholder="Laravel, Vue, React etc" value="{{ implode(', ', json_decode($model->profile->skills)) }}" />
                                    </div>
                            ...
                            <div id="test-nl-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger2">
                                <div class="row fm-body g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="address" class="form-control" rows="3">{{ $model->profile->address }}</textarea>
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">City</label>
                                        <input type="text" name="city" class="form-control" value="{{ $model->profile->city }}" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Postal Code</label>
                                        <input type="text" name="postal_code" class="form-control" value="{{ $model->profile->postal_code }}" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">State</label>
                                        <input type="text" name="state" class="form-control" value="{{ $model->profile->state }}" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Country</label>
                                        <input type="text" name="country" class="form-control" value="{{ $model->profile->country }}" />
                                    </div>
                            ...
                            <div id="test-nl-3" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger3">
                                <div class="row fm-body g-3">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <input type="text" name="highest_education" value="{{ $model->profile->highest_education }}" class="form-control" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">University</label>
                                        <input type="text" name="university" value="{{ $model->profile->university }}" class="form-control" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Major</label>
                                        <input type="text" name="major" value="{{ $model->profile->major }}" class="form-control" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Current Job Title</label>
                                        <input type="text" name="current_job_title" value="{{ $model->profile->current_job_title }}" class="form-control" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Current Company</label>
                                        <input type="text" name="current_company" value="{{ $model->profile->current_company }}" class="form-control" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Years of Experience</label>
                                        <input type="number" name="years_of_experience" value="{{ $model->profile->years_of_experience }}" class="form-control" />
                                    </div>
                            ...
                            <div id="test-nl-4" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger4">
                                <div class="row fm-body g-3">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <input type="url" name="facebook_url" placeholder="https://facebook.com/johndoe" value="{{ $model->profile->facebook_url }}" class="form-control" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Twitter</label>
                                        <input type="url" name="twitter_url" placeholder="https://twitter.com/johndoe" class="form-control" value="{{ $model->profile->twitter_url }}"/>
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Instagram</label>
                                        <input type="url" name="instagram_url" placeholder="https://instagram.com/johndoe" class="form-control" value="{{ $model->profile->instagram_url }}"/>
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">LinkedIn</label>
                                        <input type="url" name="linkedin_url" placeholder="https://linkedin.com/in/johndoe" class="form-control" value="{{ $model->profile->linkedin_url }}" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Pinterest</label>
                                        <input type="url" name="pinterest_url" value="{{ $model->profile->pinterest_url }}"  class="form-control" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">TikTok</label>
                                        <input type="url" name="tiktok_url" value="{{ $model->profile->tiktok_url }}" class="form-control" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">GitHub</label>
                                        <input type="url" name="github_url" placeholder="https://github.com/johndoe" class="form-control" value="{{ $model->profile->github_url }}" />
                                    </div>

                                    <div class="col-12 col-lg-6">
                                        <label class="form-label">Website</label>
                                        <input type="url" name="website_url" placeholder="https://johndoe.dev" class="form-control" value="{{ $model->profile->website_url }}"/>
                                    </div>
