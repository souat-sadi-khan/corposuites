<form class="ajax-form" method="POST" action="{{ route('admin.follow-ups.update', $followUp->id) }}">
    ...
    <div class="modal-header fm-modal-head">
        <div>
            ...
            <p>Update follow up: {{ $followUp->title }}</p>
        </div>
    ...
    <div class="modal-body fm-modal-body fm-body">
        <div class="fm-grid">
            <div class="fm-field fm-full">
                ...
                <input type="text" class="form-control" name="title" value="{{ old('title', $followUp->title) }}" required>
            </div>
            <div class="fm-field">
                <label>Remind At <span class="req">*</span></label>
                <input type="datetime-local" class="form-control" name="remind_at" value="{{ old('remind_at', optional($followUp->remind_at)->format('Y-m-d\TH:i')) }}" required>
            </div>
            <div class="fm-field">
