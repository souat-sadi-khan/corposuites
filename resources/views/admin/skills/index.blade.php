@extends('admin.layout.app', ['title' => 'Skills', 'modal' => 'lg'])
...
@section('content')
    ...
    <div class="nx-card tl-card">
        <div class="table-responsive">
            <table id="skillTable" data-url="{{ route('admin.skills.index') }}" class="tl-table" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Name</th>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/system/js/pages/skills.js') }}"></script>
@endpush
