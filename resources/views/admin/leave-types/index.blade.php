@extends('admin.layout.app', ['title' => 'Leave Types', 'modal' => 'lg', 'offcanvas' => '800px'])
...
@section('content')
    ...
    <div class="nx-card tl-card">
        <div class="table-responsive">
            <table id="leaveTypeTable" data-url="{{ route('admin.leave-types.index') }}" class="tl-table" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Name</th>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/system/js/pages/leave-types.js') }}"></script>
@endpush
