<div class="modal-header fm-modal-head">
    <div>
        <h5 class="modal-title">{{ $employee->full_name }}</h5>
        ...
        <div class="tab-pane fade" id="tab-contacts">
            <table class="ractivity-tbl w-100">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No emergency contacts</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="tab-pane fade" id="tab-bank">
            <table class="ractivity-tbl w-100">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No bank accounts</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="tab-pane fade" id="tab-education">
            <table class="ractivity-tbl w-100">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No education records</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="tab-pane fade" id="tab-experience">
            <table class="ractivity-tbl w-100">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No experience records</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="tab-pane fade" id="tab-career">
            ...
            <table class="ractivity-tbl w-100 mb-3">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No transfers</td></tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <table class="ractivity-tbl w-100 mb-3">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No promotions</td></tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <table class="ractivity-tbl w-100 mb-3">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No resignations</td></tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <table class="ractivity-tbl w-100">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No terminations</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="tab-pane fade" id="tab-attendance">
            <table class="ractivity-tbl w-100">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="4" class="text-center text-muted">No attendance records (showing latest 30)</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="tab-pane fade" id="tab-leave">
            ...
            <table class="ractivity-tbl w-100 mb-3">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="5" class="text-center text-muted">No leave balances</td></tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="tab-pane fade" id="tab-payroll">
            ...
            <table class="ractivity-tbl w-100 mb-3">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No salary structures</td></tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <table class="ractivity-tbl w-100">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No payroll records</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="tab-pane fade" id="tab-finance">
            ...
            <table class="ractivity-tbl w-100 mb-3">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="4" class="text-center text-muted">No expense claims</td></tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="tab-pane fade" id="tab-reviews">
            <table class="ractivity-tbl w-100">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center text-muted">No performance reviews</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
