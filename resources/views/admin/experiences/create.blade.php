<form class="ajax-form" method="POST" action="{{ route('admin.experiences.store') }}">
    <div class="modal-header fm-modal-head">
        <div>
            <h5 class="modal-title">Add Experience</h5>
            <p>Add a new work experience record for an employee</p>
        </div>
    ...
    <div class="modal-body fm-modal-body fm-body">
        <div class="fm-grid">
            ...
            <div class="fm-field">
                ...
                <input type="text" class="form-control" name="designation" required autocomplete="off">
            </div>
            <div class="fm-field">
