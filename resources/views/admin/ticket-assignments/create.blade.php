<form class="ajax-form" method="POST" action="{{ route('admin.ticket-assignments.store') }}">
    <div class="modal-header fm-modal-head">
        <div>
            <h5 class="modal-title">Assign Ticket</h5>
            <p>Hand a ticket to an agent</p>
        </div>
    ...
    <div class="modal-body fm-modal-body fm-body">
        <div class="fm-grid">
            ...
            <div class="fm-field">
                ...
                <input type="date" class="form-control" name="assigned_date" value="{{ now()->toDateString() }}" required>
            </div>
            <div class="fm-field">
