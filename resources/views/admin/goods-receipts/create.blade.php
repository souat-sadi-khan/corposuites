<form class="ajax-form goods-receipt-form" method="POST" action="{{ route('admin.goods-receipts.store') }}">
    <div class="modal-header fm-modal-head">
        <div>
            <h5 class="modal-title">Add Goods Receipt</h5>
            <p>Record goods received against a purchase order</p>
        </div>
    ...
    <div class="modal-body fm-modal-body fm-body">
        <div class="fm-grid">
            ...
            <div class="fm-field fm-full">
                <label>Notes</label>
                <textarea class="form-control" name="notes" rows="2" placeholder="Notes for this receipt"></textarea>
            </div>
        </div>
        ...
        <div class="goods-receipt-item-rows"></div>
    </div>
    ...
    {{-- Product options source, consumed client-side by goods-receipts.js. No per-row AJAX. --}}
