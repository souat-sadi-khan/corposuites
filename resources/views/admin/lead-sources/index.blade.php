@extends('admin.layout.app', ['title' => 'Lead Sources', 'modal' => 'lg'])

@section('content')
    <div class="tl-toolbar">
        <div class="tl-search">
            <i class="ri-search-line"></i>
            <input type="text" id="leadSourceSearch" placeholder="Search Lead Sources">
        </div>

        <button type="button" class="btn-nx-outline adv-search-btn" data-bs-toggle="modal" data-bs-target="#leadSourceAdvSearchModal" title="Advanced Search">
        ...
        <button id="openModal" data-url="{{ route('admin.lead-sources.how.to') }}" class="btn-nx-outline" title="How To">
            <i class="ri-question-mark"></i>
        </button>

        <!-- Add Button -->
        <button id="openModal" data-url="{{ route('admin.lead-sources.create') }}" class="btn-nx-primary">
    ...
    <div class="nx-card tl-card">
        <div class="table-responsive">
            <table id="leadSourceTable" data-url="{{ route('admin.lead-sources.index') }}" class="tl-table" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Name</th>
    ...
    <div class="modal fade" id="leadSourceAdvSearchModal" tabindex="-1" aria-hidden="true">
            ...
            <div class="nx-modal-box fm-modal-content">
                <div class="modal-header fm-modal-head">
                    <div>
                        ...
                        <p>Combine filters to find the lead sources you need.</p>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body fm-modal-body fm-body">
                    <div class="fm-grid">
                        <div class="adv-search-section"><i class="ri-radar-line"></i> Lead Source Details</div>
                        <div class="fm-field">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/system/js/pages/lead-sources.js') }}"></script>
@endpush
