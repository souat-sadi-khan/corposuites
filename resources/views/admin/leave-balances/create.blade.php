<form class="ajax-form" method="POST" action="{{ route('admin.leave-balances.store') }}">
    <div class="modal-header fm-modal-head">
        <div>
            <h5 class="modal-title">Add Leave Balance</h5>
            <p>Allocate a leave balance for an employee</p>
        </div>
    ...
    <div class="modal-body fm-modal-body fm-body">
        <div class="fm-grid">
            ...
            <div class="fm-field">
                ...
                <input type="number" step="0.01" class="form-control" name="allocated_days" min="0" value="0" required>
            </div>
            <div class="fm-field">
