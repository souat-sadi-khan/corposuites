@extends('admin.layout.app', ['title' => 'Leave Balances', 'modal' => 'lg'])

@section('content')
    @if(request('employee_id'))
        <div class="alert alert-info d-flex justify-content-between align-items-center">
            <span><i class="ri-filter-3-line me-1"></i> Showing leave balances for the selected employee.</span>
            <a href="{{ route('admin.leave-balances.index') }}" class="btn-nx-outline btn-sm">Clear Filter</a>
        </div>
    @endif
    ...
    <div class="nx-card tl-card">
        <div class="table-responsive">
            <table id="leaveBalanceTable" data-url="{{ route('admin.leave-balances.index') }}" data-employee-id="{{ request('employee_id') }}" class="tl-table" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Employee</th>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/system/js/pages/leave-balances.js') }}"></script>
@endpush
