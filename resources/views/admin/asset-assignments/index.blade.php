@extends('admin.layout.app', ['title' => 'Asset Assignment', 'modal' => 'lg'])

@section('content')
    <div class="tl-toolbar">
        <div class="tl-search">
            <i class="ri-search-line"></i>
            <input type="text" id="assetAssignmentSearch" placeholder="Search by asset or employee">
        </div>
        ...
        <!-- Add Button -->
        <button id="openModal" data-url="{{ route('admin.asset-assignments.create') }}" class="btn-nx-primary">
    ...
    <div class="nx-card tl-card">
        <div class="table-responsive">
            <table id="assetAssignmentTable" data-url="{{ route('admin.asset-assignments.index') }}" class="tl-table" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Asset</th>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/system/js/pages/asset-assignments.js') }}"></script>
@endpush
