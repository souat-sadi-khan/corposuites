<form class="ajax-form" method="POST" action="{{ route('admin.designations.update', $designation->id) }}">
    @method('PATCH')
    ...
    <div class="modal-footer fm-modal-foot">
        ...
        <div class="d-flex gap-2">
            ...
            <button type="submit" class="btn-nx-primary" id="submit"><i class="ri-check-line me-1"></i> Update</button>
