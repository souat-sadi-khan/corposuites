@extends('admin.layout.app', ['title' => 'Department Budget', 'modal' => 'xl'])

@section('content')
    <div class="tl-toolbar">
        <div class="tl-search">
            <i class="ri-search-line"></i>
            <input type="text" id="departmentBudgetSearch" placeholder="Search Department Budgets">
        </div>
        ...
        <!-- Add Button -->
        <button id="openModal" data-url="{{ route('admin.department-budgets.create') }}" class="btn-nx-primary">
    ...
    <div class="nx-card tl-card">
        <div class="table-responsive">
            <table id="departmentBudgetTable" data-url="{{ route('admin.department-budgets.index') }}" class="tl-table" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Budget</th>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/system/js/pages/department-budgets.js') }}"></script>
@endpush
