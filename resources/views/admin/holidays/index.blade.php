@extends('admin.layout.app', ['title' => 'Holidays', 'modal' => 'lg'])

@section('content')
    <div class="tl-toolbar">
        <div class="tl-search">
            <i class="ri-search-line"></i>
            <input type="text" id="holidaySearch" placeholder="Search Holidays">
        </div>
        ...
        <!-- Add Button -->
        @if(Auth::guard('admin')->user()?->can('holiday.create'))
    ...
    <div class="nx-card tl-card">
        <div class="table-responsive">
            <table id="holidayTable" data-url="{{ route('admin.holidays.index') }}" class="tl-table" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Name</th>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/system/js/pages/holidays.js') }}"></script>
@endpush
