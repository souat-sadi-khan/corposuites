@extends('admin.layout.app', ['title' => 'My Experience', 'offcanvas' => '50%', 'modal' => 'lg'])
    ...
    <div class="container-fluid p-0 profile-page">
        <div class="pm-hero card">
            ...
            <div class="pm-header">
                ...
                <div class="pm-actions">
                    ...
                    <!-- Add Button -->
                    <button id="openModal" data-url="{{ route('admin.experiences.create', ['employee_id' => Auth::guard('admin')->user()->employee_id ]) }}" class="btn-nx-primary">
        ...
        <div class="nx-card tl-card">
            <div class="table-responsive">
                <table id="experienceTable" data-url="{{ route('admin.profile.experiences') }}" data-employee-id="{{ request('employee_id') }}" class="tl-table" style="width:100%">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Company</th>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/system/js/pages/my-experiences.js') }}"></script>
@endpush
