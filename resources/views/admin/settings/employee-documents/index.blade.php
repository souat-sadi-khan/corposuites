@extends('admin.layout.app', ['title' => 'My Documents', 'offcanvas' => '50%', 'modal' => 'lg'])
    ...
    <div class="container-fluid p-0 profile-page">
        <div class="pm-hero card">
            ...
            <div class="pm-header">
                ...
                <div class="pm-actions">
                    ...
                    <!-- Add Button -->
                    <button id="openModal" data-url="{{ route('admin.employee-documents.create', ['employee_id' => Auth::guard('admin')->user()->employee_id]) }}" class="btn-nx-primary">
        ...
        <div class="nx-card tl-card">
            <div class="table-responsive">
                <table id="employeeDocumentTable" data-url="{{ route('admin.profile.documents') }}" class="tl-table" style="width:100%">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Document</th>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/system/js/pages/my-documents.js') }}"></script>
@endpush
