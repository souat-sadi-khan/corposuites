<form class="ajax-form finance-project-budget-form" method="POST" action="{{ route('admin.finance-project-budgets.store') }}">
    <div class="modal-header fm-modal-head">
        <div>
            <h5 class="modal-title">Create Project Budget</h5>
            <p>Plan a project's spend for a period, broken down by ledger account</p>
        </div>
    ...
    <div class="modal-body fm-modal-body fm-body">
        <div class="fm-grid">
            ...
            <div class="fm-field">
                <label>Title</label>
                <input type="text" class="form-control" name="title" placeholder="e.g., FY2026 Project Budget" autocomplete="off">
            </div>
            <div class="fm-field">
        ...
        <div class="finance-project-budget-item-rows"></div>
    ...
    <div class="modal-footer fm-modal-foot">
        <span class="fm-foot-note">
            <i class="ri-information-line"></i> The budget code and version number are issued automatically, scoped per project and period; the total is summed from the lines on save. Only postable (non-group) accounts can be allocated a planned amount.
        </span>
