@extends('admin.layout.app', ['title' => 'Shifts', 'modal' => 'lg', 'offcanvas' => '680px'])
...
@section('content')
    ...
    <div class="nx-card tl-card">
        <div class="table-responsive">
            <table id="shiftTable" data-url="{{ route('admin.shifts.index') }}" class="tl-table" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Name</th>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/system/js/pages/shifts.js') }}"></script>
@endpush
