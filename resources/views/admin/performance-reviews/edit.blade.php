            ...
            <div class="fm-field">
                ...
                <select name="employee_id" class="form-select select" required>
                    ...
                    @foreach($employees as $employee)
                        <option value="{{ $employee->id }}" {{ old('employee_id', $performanceReview->employee_id) == $employee->id ? 'selected' : '' }}>{{ $employee->full_name }} ({{ $employee->employee_code }})</option>
                    @endforeach
                </select>
            </div>
            <div class="fm-field">
                ...
                <select name="reviewer_id" class="form-select select">
                    ...
                    @foreach($employees as $employee)
                        <option value="{{ $employee->id }}" {{ old('reviewer_id', $performanceReview->reviewer_id) == $employee->id ? 'selected' : '' }}>{{ $employee->full_name }} ({{ $employee->employee_code }})</option>
                    @endforeach
                </select>
            </div>
            <div class="fm-field">
